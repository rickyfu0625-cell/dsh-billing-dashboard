	...
	factory: (require) => {
		...
		function makeDashboard(locale) {
			function Dashboard() {
				...
				return jsx("div", {
					style: { position: "fixed", ...dockPosition, zIndex: 2147483000, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8, pointerEvents: "none" },
					children: jsxs(Fragment, { children: [
						open && jsxs("div", { style: { ...panelStyle, pointerEvents: "auto" }, children: [
